...
Proof.
  intros.
  destruct (f b) eqn:Hb, (f true) eqn:Hft, (f false) eqn:Hff.
  all : trivial.
  - destruct b in Hb.
    + rewrite Hft in Hb.
      discriminate Hb.
...
Proof.
  ...
  - injection H.
    intros.
    simpl.
    apply IHl1 in H0. (* thanks to @VinaLx ! *)
    rewrite H0.
    reflexivity.
Qed.
